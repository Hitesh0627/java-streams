...
public class ImageToByteArray {
    public static void main(String[] args) {
        try{
            FileInputStream fis = new FileInputStream("C:\\Users\\Asus\\Desktop\\bridgelabz.workspace\\java-streams\\src\\main\\java\\com\\bridgelabz\\bytearraystream\\cartoon.png");
